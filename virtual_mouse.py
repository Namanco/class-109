...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image,(finger_tip_x,finger_tip_y),(thumb_tip_x,thumb_tip_y),(10,10,10),1)
		...
		dist = math.sqrt(((finger_tip_x-thumb_tip_x)**2) + ((finger_tip_y-thumb_tip_y)**2))
		print("Distance:", dist)
		print("Computer Screen Size:", screen_width,screen_height,"output window size:" , width,height)
		print("Mouse Position:",mouse.position, "tips Line cetner porition:", center_x,center_y)				

		# Set Mouse Position on the Screen Relative to the Output Window Size	
		relat_mo_x = (center_x/width) * screen_width
		relat_mo_y = (center_y/height) * screen_height
		mouse.position = (relat_mo_x,relat_mo_y)		
